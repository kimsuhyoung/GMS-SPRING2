...
<div id="container">
	<form id="memberAdd_form">
		...
		<input name="ssn"   type="text" value="2000-05-05"/><br />
		...
		<input id="memberAdd_yes_btn"  type="submit" value="등록"/>
		<input id="memberAdd_no_btn" type="reset" value="취소"/>
